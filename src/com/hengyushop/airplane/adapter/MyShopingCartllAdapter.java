...
import com.lelinju.www.ShoppingCartActivity;
...
//			convertView = inflater.inflate(R.layout.listviewitem, null);
			...
			holder.et_number = (TextView) convertView.findViewById(R.id.et_number);
...
//		imageLoaderll.displayImage(RealmName.REALM_NAME_HTTP + list.get(position).getImg_url(),holder.img_ware);
		query.id(holder.img_ware).image(RealmName.REALM_NAME_HTTP+list.get(position).getImg_url());
...
//     		holder.cb.setChecked(getIsSelected().get(position));
	...
	private void changeAdd(int index) {
		try {
			SharedPreferences spPreferences = context.getSharedPreferences("longuserset", Context.MODE_PRIVATE);
