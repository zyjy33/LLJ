...
public class ComboListAdapter extends BaseAdapter {
	...
	public ComboListAdapter(Context context,
			ArrayList<ComboListDomain> listDomains, ImageLoader imageLoader,Handler handler) {
	...
	public View getView(int index, View view, ViewGroup arg2) {
		...
		for (int i = 0; i < len; i++) {
			...
			holder.list_price = (Button) tempView
					.findViewById(R.id.list_price);
			holder.item_vtag = (TextView) tempView.findViewById(R.id.item_vtag);
			holder.content_id = (LinearLayout) tempView.findViewById(R.id.content_id);
			...
			view2.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 1));
