...
public class JuYunShangAdaper extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.img = (ImageView) convertView.findViewById(R.id.iv_imagr);
			...
			LinearLayout ll_shangjia = (LinearLayout) convertView.findViewById(R.id.ll_sp3);
			...
			ll_shangjia.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(mContext,WareInformationActivity.class);
