...
public class CanTuanAdapter extends BaseAdapter {
	...
	public CanTuanAdapter(ArrayList<JuTuanGouData> list,Context mContext, Handler handler) {
		super();
		this.list = list; 
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.cantuanjia_item, parent, false);
		}
...
//		TextView tv_renshu = BaseViewHolder.get(convertView, R.id.tv_renshu);
		...
		TextView tv_qucantuan = BaseViewHolder.get(convertView, R.id.tv_qucantuan);
