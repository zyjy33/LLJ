...
public class OneBuyListAdapter extends BaseAdapter {
	...
	public View getView(final int arg0, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			viewHolder.item2 = (ProgressBar) convertView.findViewById(R.id.item2);
		...
		viewHolder.item1.setText(lists.get(arg0).getName()+"\t"+"º€÷µ £§:"+lists.get(arg0).getMarket());
		...
		viewHolder.item5.setText(String.valueOf(Integer.parseInt(lists.get(arg0).getNum())-Integer.parseInt(lists.get(arg0).getJoinNum())));
		return convertView;
	}
