 ...
 * 
 */
public class BeiHuoJinMxActivity extends BaseActivity implements OnClickListener {
...
//						}
	...
	Handler handler = new Handler() {
		public void dispatchMessage(Message msg) {
			...
			case 0:
				try {
				System.out.println("=====================二级值14---"+ list.size());
...
//								refresh.setVisibility(View.GONE);
								Toast.makeText(BeiHuoJinMxActivity.this, info, 200)
										.show();
							}
...
//								refresh.setVisibility(View.GONE);
								Toast.makeText(BeiHuoJinMxActivity.this, info, 200).show();
							}
							Message msg = new Message();
							msg.what = 0;
							msg.obj = list;
