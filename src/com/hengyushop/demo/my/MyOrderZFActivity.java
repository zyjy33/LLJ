	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			case R.id.item0:
				...
				intent.putExtra("activity_hd",getIntent().getStringExtra("activity_hd"));
				startActivity(intent);
				finish();
//				Toast.makeText(MyOrderZFActivity.this, "功能正在完善",Toast.LENGTH_SHORT).show();
				break;
			case R.id.item1:
				break;
			case R.id.item2:// 支付宝
...
//					Toast.makeText(MyOrderConfrimActivity.this, "支付NO", Toast.LENGTH_SHORT).show();
				}
				} catch (Exception e) {
					// TODO: handle exception
					e.printStackTrace();
...
//			recharge_no = recharge_no3;
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL
				+ "/payment_sign?user_id="+user_id+"&user_name="+user_name+"" +
					"&total_fee="+total_c+"&out_trade_no="+recharge_no+"&payment_type=alipay",
...
//			recharge_no	= recharge_no2;
		System.out.println("订单==================="+recharge_no);	
		 ...
		 System.out.println("订单monney==================="+monney);	
		AsyncHttp.get(RealmName.REALM_NAME_LL
				+ "/payment_sign?user_id="+user_id+"&user_name="+user_name+"" +
...
//			Toast.makeText(MyOrderConfrimActivity.this, "走到这里了2", 200).show();
		   AsyncHttp.get(RealmName.REALM_NAME_LL
							    	   ...
							    	   JSONObject jsonObject = object.getJSONObject("data");
										...
										for (int j = 0; j < jay.length(); j++){
										   ...
										   UserAddressData data = new UserAddressData();
										    data.accept_name = objc.getString("accept_name");
...
//										 Toast.makeText(MyOrderZFActivity.this, datetime+"/"+give_pension, 200).show();
							    	   Toast.makeText(MyOrderZFActivity.this, info, 200).show();
							    	   System.out.println("activity_hd================================="+getIntent().getStringExtra("activity_hd"));
										     //活动支付成功不显示详情 
