 ...
 * 
 */
public class MyJuDuiHuanActivity extends BaseActivity implements OnClickListener {
...
//	private List<OrderBean> lists;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		madapter = new MyOrderllAdapter(list,MyJuDuiHuanActivity.this,handler);
...
//									System.out.println("====list.size()========="+list.size());
									...
									if (list.size() == 0) {
										...
										Toast.makeText(MyJuDuiHuanActivity.this, "没有订单了", 200).show();
									}
								}
						...
						try {
							...
							System.out.println("确认付款================================="+arg1);
							  String status = object.getString("status");
							    ...
							    if (status.equals("y")) {
									  progress.CloseProgress();
									  Toast.makeText(MyJuDuiHuanActivity.this, info, 200).show();
							    }else {
							    	progress.CloseProgress();
									Toast.makeText(MyJuDuiHuanActivity.this, info, 200).show();
								}
...
//							    	   finish();
					...
					public void onFailure(Throwable arg0, String arg1) {
						...
						Toast.makeText(MyJuDuiHuanActivity.this, "更新订单网络超时异常", 200).show();
					}
