...
//	private List<OrderBean> lists;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		madapter = new MyOrderllAdapter(list,MyJuTuanActivity.this,handler);
...
//			}
			...
			if (type.equals("2")) {
				textView1.setText("我的聚兑换");
			}
			else
				if (type.equals("3")) {
				textView1.setText("我的聚团");
			}
...
//				list.clear();
				...
				item2();
				strwhere = "payment_status=1%20and%20datatype=3";
//				list.clear();
				load_list(true,strwhere);
			}else if (status.equals("2")) {
				item3();
				strwhere = "payment_status=2%20and%20express_status=1%20and%20datatype=3";
//				list.clear();
				load_list(true,strwhere);
			}else if (status.equals("3")) {
				item4();
				strwhere = "payment_status=2%20and%20express_status=2%20and%20status=2%20and%20datatype=3";
//				list.clear();
				load_list(true,strwhere);
			}else if (status.equals("4")) {
				item5();
				strwhere = "payment_status=2%20and%20express_status=2%20and%20status=3%20and%20datatype=3";
//				list.clear();
				load_list(true,strwhere);
			}
		}else{
...
//			System.out.println("=========list11============"+list.size());
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL+ "/get_order_page_size_list?user_id="+user_id+"" +
				"&page_size="+VIEW_NUM+"&page_index="+CURRENT_NUM+"&strwhere="+strwhere+"&datatype=&orderby=",
				new AsyncHttpResponseHandler() {
							...
							public void onSuccess(int arg0, String arg1) {
								...
								md.setCashing_packet(obj.getString("cashing_packet"));
...
//									System.out.println("====list.size()========="+list.size());
									...
									if (list.size() == 0) {
										...
										Toast.makeText(MyJuTuanActivity.this, "没有订单了", 200).show();
									}
								}
...
//			recharge_no = recharge_noll;
		   ...
		   AsyncHttp.get(RealmName.REALM_NAME_LL
				+ "/update_order_payment?user_id="+user_id+"&user_name="+user_name+"" +
						"&order_no="+recharge_noll+"&sign="+login_sign+"",
...
//							    	   finish();
							    	   Toast.makeText(MyJuTuanActivity.this, info, 200).show();
							    	   Intent intent = new Intent(MyJuTuanActivity.this,ZhiFuOKActivity.class);
									   startActivity(intent);
							    }else {
							    	progress.CloseProgress();
							    	teby = false;
					...
					public void onFailure(Throwable arg0, String arg1) {
						...
						Toast.makeText(MyJuTuanActivity.this, "更新订单网络超时异常", 200).show();
					}
