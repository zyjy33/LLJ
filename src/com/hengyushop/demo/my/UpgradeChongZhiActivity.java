 ...
 *
 */
public class UpgradeChongZhiActivity extends BaseActivity implements OnClickListener{
	private Button chongzhi_submit;
	private EditText chongzhi_edit,EditText;
	private TextView tv_peixunfei,tv_xujiaobzj,tv_zhifubzj,yfje_edit,tv_chuangke1,tv_chuangke2;
		...
		chongzhi_submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				try {
					...
					System.out.println("monney==============="+monney1);
...
//						Toast.makeText(getApplicationContext(), "暂时无法支付",200).show();
					...
					Toast.makeText(getApplicationContext(), "请输入正确的金额,不能小于100", 200).show();	
						...
						if (jine >= 1000) {	
							double monney1 = Double.parseDouble(monney_ll);
							System.out.println("monney1==============="+monney1);
							rebate_price = train_price + monney1;
							System.out.println("rebate_price==============="+rebate_price);
							amount = String.valueOf(rebate_price);
							yfje_edit.setText(amount);
							System.out.println("amount=======2======="+amount);
							if(yu_pay_c0.isChecked()){
...
//								Toast.makeText(getApplicationContext(), "暂时无法支付",200).show();
							...
							Toast.makeText(getApplicationContext(), "请输入正确的金额,不能小于1000", 200).show();	
							}
					}
...
//			double monney1 = Double.parseDouble(chongzhi_edit.getText().toString());
//			rebate_price = train_price + monney1;
//			amount = String.valueOf(rebate_price);
//			yfje_edit.setText(amount);
...
//				yfje_edit.setText(chongzhi_edit.getText());
	...
	private void getpeixunfei(){
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL
				+ "/get_user_rebate_item_model?id="+rebate_item_id+"",
							...
							System.out.println("2================================="+arg1);
							  String status = object.getString("status");
							    ...
							    if (status.equals("y")) {
							    	...
							    	minexp_price = obj.getDouble("minexp_price");
							    	payable_price = obj.getDouble("payable_price");
//							    	rebate_price = obj.getDouble("rebate_price");
									
							    	System.out.println("train_price==============="+train_price);	
...
//        yfje_edit.setText(amount);
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL
				+ "/add_amount_recharge?user_id="+user_id+"&user_name="+user_name+"" +
						"&amount="+amount+"&fund_id=5&payment_id="+payment_id+"&rebate_item_id="+rebate_item_id+"",
				new AsyncHttpResponseHandler() {
					@Override
					public void onSuccess(int arg0, String arg1) {
						super.onSuccess(arg0, arg1);
							  ...
							  String status = object.getString("status");
							    ...
							    if (status.equals("y")) {
									...
									System.out.println("11================================="+data.recharge_no );
									  ...
									  if (fangshi.equals("2")) {
										//余额支付
//											Intent intent = new Intent(UpgradeChongZhiActivity.this, TishiChongZhiActivity.class);
										    Intent intent = new Intent(UpgradeChongZhiActivity.this, TishiCarArchivesActivity.class);
											intent.putExtra("order_no",recharge_no);
//											intent.putExtra("chuangke_sj","chuangke_sj");
											intent.putExtra("yue","yue");
											startActivity(intent);
									  }else {
									  loadzhidu(recharge_no);//支付宝
									  }
							    }else {
							    	progress.CloseProgress();
									Toast.makeText(UpgradeChongZhiActivity.this, info, 200).show();
...
//							    	   progress.CloseProgress();
////							    	   Toast.makeText(UpgradeChongZhiActivity.this, info, 200).show();
//							    	   Intent intent = new Intent(UpgradeChongZhiActivity.this,ChuangKeUserActivity.class);
//									   startActivity(intent);
//									   finish();
//									   ChuangKeActivity.handler.sendEmptyMessage(2);
//							    }else {
		...
		public void dispatchMessage(Message msg) {
			...
			case 5://支付宝
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					Toast.makeText(UpgradeChongZhiActivity.this, "支付成功",Toast.LENGTH_SHORT).show();
