...
//						processWX(yue);
					...
					}else if (yu_pay_c1.isChecked()) {//支付宝微信
...
//						Toast.makeText(getApplicationContext(), "暂时无法支付",200).show();
						...
						Toast.makeText(getApplicationContext(), "请选择支付方式",100).show();
					}
...
//									Toast.makeText(ChongZhiActivity.this, info, 200).show();
					...
					public void onFailure(Throwable arg0, String arg1) {
						...
						Toast.makeText(UserChongZhiActivity.this, "网络超时异常", 200).show();
					}
...
//		System.out.println("===============111--"+timestamp);
	...
	private void ali_pay() {
		//
		String orderInfo = getOrderInfo("充值备货金", "商品描述", recharge_no);
...
//						Toast.makeText(ChongZhiActivity.this, "支付OK", Toast.LENGTH_SHORT).show();
					} catch (Exception e) {
						// TODO: handle exception
						e.printStackTrace();
					}
				}else {
//					Toast.makeText(ChongZhiActivity.this, "支付NO", Toast.LENGTH_SHORT).show();
				}
			...
			case 5://支付宝
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					Toast.makeText(UserChongZhiActivity.this, "支付成功",Toast.LENGTH_SHORT).show();
					userloginqm();
				} else {
					// 判断resultStatus 为非“9000”则代表可能支付失败
					// “8000”代表支付结果因为支付渠道原因或者系统原因还在等待支付结果确认，最终交易是否成功以服务端异步通知为准（小概率状态）
					if (TextUtils.equals(resultStatus, "8000")) {
						Toast.makeText(UserChongZhiActivity.this, "支付结果确认中",
								Toast.LENGTH_SHORT).show();

					} else {
						// 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
						Toast.makeText(UserChongZhiActivity.this, "支付失败",
								Toast.LENGTH_SHORT).show();
