...
import com.android.hengyu.pub.ZamsHuoDongAdapter;
...
//	private RelativeLayout home_title_layout;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View layout = inflater.inflate(R.layout.activity_huodong_fragment, null);//
//		View layout = inflater.inflate(R.layout.hengyu_activity, null);//  hengyu_activity second_main_content_activity
...
//		home_main_scrool = (PagerScrollView) layout.findViewById(R.id.home_main_scrool);
		home_title_layout = (LinearLayout) layout.findViewById(R.id.home_title_layout);
...
//	String user_name_key = "";
	...
	public void onResume() {
		...
		SharedPreferences spPreferences = getActivity().getSharedPreferences("longuserset_city", Context.MODE_PRIVATE);
...
//			if (!nickname.equals("")) {
//			if (!user_name.equals("")) {
//				Intent Intent2 = new Intent(getActivity(),ZhongAnMinShenXqActivity.class);
//				startActivity(Intent2);
//			} else {
//				Intent intent2 = new Intent(getActivity(), TishiWxBangDingActivity.class);
//				startActivity(intent2);
...
//			startActivity(intent48);
//		}else {
//			Intent intent48 = new Intent(getActivity(), ZhongAnMinShenXqActivity.class);
//			startActivity(intent48);
//		}
//		}
			break;
...
//			list_ll = new ArrayList<JuTuanGouData>();
//		}
//			AsyncHttp.get(RealmName.REALM_NAME_LL+"/get_article_page_size_list?channel_name=signup&category_id=0" +
...
//												System.out.println("1----------title-----------"+data.getTitle());
//												list_ll.add(data);
//											}
////											Toast.makeText(JuTuanGouActivity.this, info, 200).show();
//											System.out.println("list_ll.size()--------1--------"+list_ll.size());
////											ZamsHuoDongAdapter juJingCaiAdapter = new ZamsHuoDongAdapter(getActivity(), list_ll);
...
//      AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_category_list?channel_name=signup&category_id=0" +
//              "&top=100&strwhere="
				, new AsyncHttpResponseHandler() {
			@Override
			public void onSuccess(int arg0, String arg1) {
...
//		progress.CreateProgress();
			AsyncHttp.get(RealmName.REALM_NAME_LL+ "/get_article_top_list?channel_name=signup&top=1&strwhere=status=0%20and%20is_top=1"
					,new AsyncHttpResponseHandler() {
					@Override
					public void onSuccess(int arg0, String arg1) {
						// TODO Auto-generated method stub
...
//				data.marketPrice = object.getString("market_price");
				datas.add(data);
				mAq.id(iv_zhuti_tp).image(RealmName.REALM_NAME_HTTP + data.img_url);
