...
public class FlyResultAdapter extends BaseAdapter {
	...
	public View getView(final int index, View view, ViewGroup arg2) {
		...
		holder.textView3.setText(db1.getJicBySam(results.get(index).getOrgCity())
				+ results.get(index).getOrgJetquay());
		...
		holder.textView6.setText("£§" + results.get(index).getPrice());// º€∏Ò
		holder.textView7.setText("(" + results.get(index).getDiscount() + "’€)");// ’€ø€
