...
public class MerchantsLabelActivity extends Activity implements OnClickListener{
	...
	private final String[] titles = { "汽车", "餐饮", "开网店", "摄影",
			"服装搭配", "手工制作","商城", "减肥", "养老服务", "按摩", "炒股","电子商务" };
...
//				}else{
					...
					if (mTags2.size() >= 3) {
						Toast.makeText(getApplicationContext(),"最多选三个", 2000).show();
//						mTags2.clear();
					}else {
...
//			String str="";
			...
			public void onClick(View arg0) {
				if (mTags2.size() == 0) {
					Toast.makeText(getApplicationContext(),"请选择商家标签", 2000).show();	
				}else {
