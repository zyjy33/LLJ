 ...
 * 
 */
public class ApplyBusinessActivity extends BaseActivity implements OnClickListener,
...
//			loadguanggao();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shenqing_shangjia);//activity_shenqing_shangjia activity_shengqing
...
//		iv_fanhui.setOnClickListener(this);
		...
		btn_settle_accounts.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				try {
				Intent intent = new Intent(ApplyBusinessActivity.this, ApplyBusiness1Activity.class);
...
//			Bitmap bitmap_dihua = BitmapFactory.decodeResource(getResources(), R.drawable.pic1);
