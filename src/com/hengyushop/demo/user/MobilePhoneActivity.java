package com.hengyushop.demo.user;
...
//				startActivity(intent);
	...
	public void onClick(View v) {
		...
		case R.id.get_yz:
			...
			if (phone.equals("")) {
				Toast.makeText(MobilePhoneActivity.this, "手机号码不能为空", 200).show();
			}else if (phone.length() < 11 ) {
				Toast.makeText(MobilePhoneActivity.this, "手机号码少于11位", 200).show();
			}else {
							...
							public void onSuccess(int arg0, String arg1) {
								...
								try {
									...
									if (result.equals("y")) {
									    ...
									    Toast.makeText(MobilePhoneActivity.this, info, 200).show();
//										handler.sendEmptyMessage(3);
		...
		case R.id.img_title_login:
			int index = 0;
			Intent intent = new Intent(MobilePhoneActivity.this,UserLoginActivity.class);
		...
		case R.id.btn_register:
			...
			if (phone.equals("")) {
				...
				Toast.makeText(MobilePhoneActivity.this, "验证码不能为空", 200).show();
			}else if (pwd.equals("")) {
				Toast.makeText(MobilePhoneActivity.this, "密码不能为空", 200).show();
			}else {
						...
						public void run() {
							try {
								...
								String oauth_openid = spPreferences_login.getString("oauth_openid", "");
								 ...
								 System.out.println("headimgurl========0========"+headimgurl);
...
//									headimgurl2 = spPreferences_qq.getString("headimgurl2", "");
...
//									 headimgurl = headimgurl2;
									 System.out.println("headimgurl2========1========"+headimgurl);
								}else {
...
//									 spPreferences_login = getSharedPreferences("longuserset_login", MODE_PRIVATE);
								...
								oauth_name = spPreferences_ptye.getString("ptye", "");
//								if (UserLoginActivity.oauth_name.equals("weixin")) {
//									oauth_name = "weixin";
//									UserLoginActivity.oauth_name = "";
//								}else if (UserLoginWayActivity.oauth_name.equals("qq")) {
//									oauth_name = "qq";
//									UserLoginWayActivity.oauth_name = "";
//								}
								
								System.out.println("=================oauth_name==" + oauth_name);
								
								SharedPreferences spPreferences = getSharedPreferences("longuserset_tishi", MODE_PRIVATE);
...
//								SharedPreferences spPreferences_3_wx = getSharedPreferences("longuserset_3_wx", MODE_PRIVATE);
...
//								String strUrl = RealmName.REALM_NAME_LL + "/user_oauth_bind_0215?mobile="+phone+"&code="+yz+"&nick_name="+nickname+"&sex="+sex+"&avatar="+headimgurl+"" +
//										"&province="+province+"&city="+city+"&country="+country+"&oauth_name="+oauth_name+"&oauth_access_token="+access_token+"&oauth_unionid="+unionid+"";
								
								String strUrl = RealmName.REALM_NAME_LL + "/user_oauth_bind_0217?mobile="+phone+"&password="+pwd+"&code="+yz+"&nick_name="+nickname+"" +
...
//												String reg_site = obj.getString("reg_site");
												
												SharedPreferences spPreferences_ptye = getSharedPreferences("longuserset_ptye", MODE_PRIVATE);
												spPreferences_ptye.edit().clear().commit();
												
//												if (oauth_name.equals("weixin")) {
//													SharedPreferences spPreferences = getSharedPreferences("longuserset_3_wx", MODE_PRIVATE);
//													Editor editor = spPreferences.edit();
//													editor.putString("user_wx", data.user_name);
//													editor.putString("user_id", data.id);
//													editor.commit();
//													System.out.println("=================user_wx==");
//												}else if (oauth_name.equals("qq")){
//													SharedPreferences spPreferences = getSharedPreferences("longuserset_3_qq", MODE_PRIVATE);
//													Editor editor = spPreferences.edit();
//													editor.putString("user_qq", data.user_name);
//													editor.putString("user_id", data.id);
//													editor.commit();
