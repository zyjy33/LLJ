 ...
 *
 */
public class EndowmentBankActivity extends BaseActivity implements OnClickListener{
...
//		btn_login.setOnClickListener(this);
	...
	private void loadxfylj() {
		...
		if (to_user_id != null) {
			 strUrlone = RealmName.REALM_NAME_LL + "/get_payrecord_income_sum?to_user_id="+to_user_id+"" +
			 		"&fund_id=4&day=0";
	...
	private void loadlilv() {
		String user_id = spPreferences.getString("user_id", "");
			 strUrlone = RealmName.REALM_NAME_LL + "/get_payrecord_rate?user_id="+user_id+"" +
			 		"&months=600";
			...
			public void onSuccess(int arg0, String arg1) {
				try {
					...
					for (int i = 0; i < jaArray.length(); i++) {
						...
						System.out.println("======22222============="+data.pensions);
						list2.add(data);
					}
					try {
...
//					}
	...
	public void onClick(View v) {
		...
		case R.id.index_item0:
			...
			Intent intent = new Intent(EndowmentBankActivity.this, EndowmentBankMxActivity.class);
		...
		case R.id.index_item1:
			Intent intent1 = new Intent(EndowmentBankActivity.this, EndowmentBankMxActivity.class);
		...
		case R.id.index_item2:
			Intent intent2 = new Intent(EndowmentBankActivity.this, EndowmentBankMxActivity.class);
		...
		case R.id.fanhui:
			...
			break;
		case R.id.btn_login:
			Intent intent3 = new Intent(EndowmentBankActivity.this, YangLaoChongZhiActivity.class);
			startActivity(intent3);
			break;
		case R.id.enter_shop:
			Intent intent4 = new Intent(EndowmentBankActivity.this,Webview1.class);
			intent4.putExtra("ylyh_id", "6060");
