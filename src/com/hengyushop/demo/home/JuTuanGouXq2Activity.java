...
import com.android.hengyu.pub.TuanchengyuanAdapter;
				...
				try {
					if (user_name.equals("")) {
						...
						if (UserLoginActivity.wx_fanhui == false) {
							...
							System.out.println("=======subtitle===========2====================="+subtitle);
							System.out.println("=======imgs_url===========2====================="+imgs_url);
							System.out.println("=======ct_id===========2====================="+ct_id);
...
//						intentll.putExtra("img_url", data.getImgs_url());
...
//				gridView2.setAdapter(adapter);
	...
	private void getjutuanuser(String trade_no) {
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_member_list?trade_no="+trade_no+"&top=1"
...
//					handler.sendEmptyMessage(1);
	 ...
	 * @param category_id 
	 */
	public static String img_url,sell_price,article_id,goods_id,price;
...
//						intent.putExtra("img_url", data.getImgs_url());
						intent.putExtra("fx_shuzi",fx_cs);
						intent.putExtra("subtitle",subtitle);
						intent.putExtra("img_url", imgs_url);
						startActivity(intent);
					}
				}else {
					//、聚精彩聚团、预售团提示分享
