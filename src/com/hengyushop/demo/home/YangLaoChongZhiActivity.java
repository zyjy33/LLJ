 ...
 *
 */
public class YangLaoChongZhiActivity extends BaseActivity implements OnClickListener{
	...
	private void loadguanggao(String payment_id) {
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL
				+ "/add_amount_recharge?user_id="+user_id+"&user_name="+user_name+"" +
						"&amount="+amount+"&fund_id=4&payment_id="+payment_id+"&rebate_item_id=0",
...
//										loadzhidu(recharge_no);
									  if (pety.equals("2")) {
//										  loadYue(recharge_no);
											Intent intent = new Intent(YangLaoChongZhiActivity.this, TishiCarArchivesActivity.class);
							    	...
							    	progress.CloseProgress();
									Toast.makeText(YangLaoChongZhiActivity.this, info, 200).show();
								}
...
//									Toast.makeText(YangLaoChongZhiActivity.this, info, 200).show();
					...
					public void onFailure(Throwable arg0, String arg1) {
						...
						Toast.makeText(YangLaoChongZhiActivity.this, "网络超时异常", 200).show();
					}
