...
public class TishiPensionActivity extends Activity implements OnClickListener{
	...
	protected void initUI() {
		try {
//			System.out.println("1================================="+TishiCarArchivesActivity.give_pension);
			System.out.println("22================================="+MyOrderConfrimActivity.accept_name1);
			System.out.println("33================================="+MyOrderZFActivity.accept_name);
...
//		textView1.setText("将进"+give_pension+"元");
		textView1.setText("将进"+getIntent().getStringExtra("give_pension")+"元");
...
//			  intent.putExtra("sp_id", article_id);
			  intent.putExtra("sp_id", getIntent().getStringExtra("article_id"));
