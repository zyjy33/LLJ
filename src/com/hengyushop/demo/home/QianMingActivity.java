...
import com.lglottery.www.adapter.TuiGuangListAdapter;
...
//				TuiGuangBean content = (TuiGuangBean) msg.obj;
	...
	private void load_list(boolean flag, String id) {
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL+"/get_test_exam_list?" +
                "channel_name=question&lesson_id="+id+"&page_size="+VIEW_NUM+"&page_index="+CURRENT_NUM+"&strwhere=&orderby=", new AsyncHttpResponseHandler(){
	...
	private void load_listll(boolean flag, String id) {
		...
		if(flag){
			...
			AsyncHttp.get(RealmName.REALM_NAME_LL+"/get_article_page_size_list?" +
	                "channel_name=content&category_id="+id+"&page_size="+VIEW_NUM+"&page_index="+CURRENT_NUM+"&strwhere=&orderby=", new AsyncHttpResponseHandler(){		
							@Override
							public void onSuccess(int arg0, String arg1) {
								// TODO Auto-generated method stub
								super.onSuccess(arg0, arg1);
