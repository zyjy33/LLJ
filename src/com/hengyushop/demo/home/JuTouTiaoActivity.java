	...
	Handler handler = new Handler() {
		public void dispatchMessage(Message msg) {
			...
			case 0:
				...
				MyjuTouTiaoAdapter adapter = new MyjuTouTiaoAdapter(list,JuTouTiaoActivity.this, imageLoader);
...
//		key = registerData.getUserkey();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				System.out.println("=================1="+list.get(arg2).id_ll);
				Intent intent= new Intent(JuTouTiaoActivity.this,Webview1.class);
				intent.putExtra("list", list.get(arg2).id_ll);
	...
	private void loadWeather() {
		...
		strUrl = RealmName.REALM_NAME_LL+ "/get_article_category_id_list?channel_name=news&category_id=3" +
				"&top=10&strwhere=";
...
//				data.collectTotal = object.getString("collectTotal");
			...
			handler.sendMessage(msg);
					...
					progress.CloseProgress();
					Toast.makeText(JuTouTiaoActivity.this, info, 200).show();
				}
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
