...
//		bt_cart_edit.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.bt_cart_all:
			...
			show_cart_low.setBackgroundColor(getResources().getColor(R.color.all_wenzi));
			show_cart_stock.setBackgroundColor(getResources().getColor(R.color.all_wenzi));
			break;
		case R.id.bt_cart_low:
			...
			show_cart_all.setBackgroundColor(getResources().getColor(R.color.all_wenzi));
			show_cart_stock.setBackgroundColor(getResources().getColor(R.color.all_wenzi));
		...
		case R.id.bt_cart_stock:
			...
			show_cart_stock.setBackgroundColor(getResources().getColor(R.color.hongse));
			show_cart_all.setBackgroundColor(getResources().getColor(R.color.all_wenzi));
			show_cart_low.setBackgroundColor(getResources().getColor(R.color.all_wenzi));
