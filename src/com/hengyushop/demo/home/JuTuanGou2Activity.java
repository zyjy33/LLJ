...
public class JuTuanGou2Activity extends BaseActivity implements OnClickListener{
	...
	private List<JuTuanGouData> list_1 = new ArrayList<JuTuanGouData>();
	private List<JuTuanGouData> list_2 = new ArrayList<JuTuanGouData>();
	private List<JuTuanGouData> list_3 = new ArrayList<JuTuanGouData>();
...
//	private int INDX = -1;
	...
	String category_id = "";
	private TextView tv_time1,tv_titel1,tv_price1,tv_groupon_price1,tv_tuan1,tv_anniu1;
	private TextView tv_time2,tv_titel2,tv_price2,tv_groupon_price2,tv_tuan2,tv_anniu2;
	private TextView tv_time3,tv_titel3,tv_price3,tv_groupon_price3,tv_tuan3,tv_anniu3;
	private TextView tv_time4,tv_titel4,tv_price4,tv_groupon_price4,tv_tuan4,tv_anniu4;
...
//					data.groupon_title = "恭喜"+data.user_name+"抢到"+obt.getString("groupon_title");
		...
		try {
			...
			mytaobao.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(JuTuanGou2Activity.this, JuTouTiaoActivity.class);
...
//			break;
		case R.id.ll_tuangou1:
			Intent intent0 = new Intent(JuTuanGou2Activity.this, JuJingCaiXqActivity.class);
...
//			intent2.putExtra("type_xq", "2");
		...
		case R.id.ll_tuangou4:
			...
			DBFengXiangActivity.fanhui_type = false;
			UserLoginActivity.fanhui_type = false;
			Intent intent3 = new Intent(JuTuanGou2Activity.this, JuTuanGouXqActivity.class);
	...
	private Handler handler = new Handler(){
		public void dispatchMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				System.out.println("个数是多少2===================="+list_1.size());
	...
	private void loadWeather() {
		progress.CreateProgress();
//		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_game_groupon_top?channel_name=groupon&category_id=0&top=1"
		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_top_list_2017?channel_name=groupon&top=1&strwhere="	
...
//						String title = list_1.get(0).getTitle();
//						System.out.println("title====1====="+title);
						...
						tv_tuan1.setText(list_1.get(0).getPeople()+"人团");
...
//						 mAq.id(ll_tupian1).image(RealmName.REALM_NAME_HTTP+list_1.get(0).getImg_url());
							...
							try {
								now_1 = df.parse(list_1.get(0).getEnd_time());
...
//						progress.CloseProgress();
//						Toast.makeText(JuTuanGou2Activity.this, info, 200).show();
					}
					progress.CloseProgress();
					loadWeather2();
...
//		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_game_groupon_top?channel_name=group&category_id=0&top=1"
		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_top_list_2017?channel_name=group&top=1&strwhere="
				, new AsyncHttpResponseHandler() {
			@Override
			public void onSuccess(int arg0, String arg1) {
				// TODO Auto-generated method stub
...
//							data.setGroupon_price(obj.getString("groupon_price"));
						...
						System.out.println("2---------------------"+list_2.size());
						...
						tv_tuan2.setText(list_2.get(0).getPeople()+"人团");
...
//						 mAq.id(ll_tupian2).image(RealmName.REALM_NAME_HTTP+list_2.get(0).getImg_url());
						 ...
						 SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
							...
							try {
								now_2 = df.parse(list_2.get(0).getEnd_time());
							} catch (java.text.ParseException e1) {
								// TODO Auto-generated catch block
								e1.printStackTrace();
							}
...
//		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_game_groupon_top?channel_name=ladder&category_id=0&top=1"
		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_top_list_2017?channel_name=ladder&top=1&strwhere="
				, new AsyncHttpResponseHandler() {
			@Override
			public void onSuccess(int arg0, String arg1) {
				// TODO Auto-generated method stub
...
//							data.setGroupon_price(obj.getString("groupon_price"));
						...
						tv_tuan3.setText(list_3.get(0).getPeople()+"人团");
...
//						 mAq.id(ll_tupian3).image(RealmName.REALM_NAME_HTTP+list_3.get(0).getImg_url());
						 ...
						 SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
							...
							try {
								now_3 = df.parse(list_3.get(0).getEnd_time());
							} catch (java.text.ParseException e1) {
								// TODO Auto-generated catch block
								e1.printStackTrace();
							}
...
//		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_game_groupon_top?channel_name=onebuy&category_id=1728&top=1"
//				, new AsyncHttpResponseHandler() {
//			@Override
//			public void onSuccess(int arg0, String arg1) {
//				// TODO Auto-generated method stub
...
//							list_4.add(data);
//						}
//						System.out.println("4---------------------"+list_4.size());
//						progress.CloseProgress();
...
//						 imageLoader.clearMemoryCache();
////						 mAq.id(ll_tupian4).image(RealmName.REALM_NAME_HTTP+list_4.get(0).getImg_url());
//						 
////						handler.sendEmptyMessage(2);
////						Toast.makeText(JuTuanGou2Activity.this, info, 200).show();
//					}else {
//						ll_tuangou4.setVisibility(View.GONE);
//						progress.CloseProgress();
////						Toast.makeText(JuTuanGou2Activity.this, info, 200).show();
//					}
//					progress.CloseProgress();
