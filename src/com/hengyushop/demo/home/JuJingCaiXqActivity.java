...
//		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_model?id="+groupon_id+""
		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_myselft_list?user_id="+user_id+"&user_name="+user_name+"&article_id="+groupon_id+"&datatype=5&top=5"
...
//						
					...
					webview.loadUrl(RealmName.REALM_NAME_WEB+"/mobile/goods/conent-"+data.article_id+".html");//商品介绍
					progress.CloseProgress();
