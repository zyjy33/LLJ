 ...
 *
 */
public class EndowmentBankMxActivity extends BaseActivity implements OnClickListener{
...
//		}
		...
		double   ye2   =   pen2.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		double   ye3   =   pen3.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		double   ye4   =   pen4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		double   ye5   =   pen5.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
...
//			Intent intent1 = new Intent(ChuangKeActivity.this,ShengJiCkActivity.class);
////			Intent intent = new Intent(ChuangKeActivity.this,ChongZhiActivity.class);
