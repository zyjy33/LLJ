...
public class CommomConfrim extends Activity{
	...
	public static Dialog showSheet(final Context context,
		...
		LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.market_information_sep_pop_ll, null);
...
//				"channel_name=life&parent_id="+id+"",new AsyncHttpResponseHandler() {
//					@Override
...
//							listll.add(dm);
//							
//							System.out.println("=====循环的id====================="+data2);
////							load_list(INDX, true);
//				    		}
//				    		
////				    		gridView.setVisibility(View.VISIBLE);	
//				    			System.out.println("=====11====================="+data2);	
//				    			
//				    		arrayadapter = new MyGridAdapter(data2,context);
