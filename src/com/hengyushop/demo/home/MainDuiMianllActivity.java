		...
		btn_data.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (TextUtils.isEmpty(haoma)) {
					Toast.makeText(MainDuiMianllActivity.this, "请输入手机号", 200).show();
				}else if (haoma.length() < 11 ) {
					Toast.makeText(MainDuiMianllActivity.this, "手机号少于11位", 200).show();
				}else {	
...
//					bitmap_tx = bitmap_touxiang;
	...
	public void onClick(View v) {
		...
		case R.id.ll_mdm_sys:
			if (erweima.equals("")) {
				Toast.makeText(MainDuiMianllActivity.this, "请添加好友手机号", 200).show();
			}else {
