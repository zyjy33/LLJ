 ...
 * 
 */
public class JuTuanGouActivity extends BaseActivity implements OnClickListener,UncaughtExceptionHandler{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Jutuangouadapter = new JuTuanGouAdapter(getApplicationContext(), list);
...
//		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_game_groupon_list?page_size=" + VIEW_NUM + "" +
//				"&page_index=" + CURRENT_NUM + "&channel_name="+zhuangtai+"&category_id="+0+""
		
		AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_page_size_list_2017?channel_name="+zhuangtai+"&category_id=0" +
