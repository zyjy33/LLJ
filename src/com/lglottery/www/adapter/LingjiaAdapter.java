...
public class LingjiaAdapter extends BaseAdapter {
	...
	public View getView(int position, View view, ViewGroup arg2) {
		...
		holder.text2.setText(lists.get(position).getPrice()+"元+"+lists.get(position).getJifen()+"聚币");
		holder.text3.setText(0+"人已购买");
		holder.text4.getPaint().setFlags(Paint. STRIKE_THRU_TEXT_FLAG |Paint.ANTI_ALIAS_FLAG);
