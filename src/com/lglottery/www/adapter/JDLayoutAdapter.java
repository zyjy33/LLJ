...
public class JDLayoutAdapter extends BaseAdapter {
	...
	public JDLayoutAdapter(Context context, ArrayList<JDbean> list,ImageLoader imageLoader,double lat,double log) {
	...
	public View getView(int index, View view, ViewGroup arg2) {
		...
		holder.item4.setText(list.get(index).getAmount()+"元");
			...
			if(jl>1000){
				holder.item5.setText(String.valueOf(Math.floor(jl/1000))+"公里");
			}else {
