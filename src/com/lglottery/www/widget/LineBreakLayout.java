...
//			child.layout(lengthX - width, lengthY - height, lengthX, lengthY);
			System.out.println(lengthX - width+"--"+lengthX+"---"+width);
			child.layout(lengthX - width-63, lengthY - height, lengthX-63, lengthY);
		}
	
//		this.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, ROWCOUNT = (row+1)*height));
