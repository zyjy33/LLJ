...
public class MyShopCartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.shopcart_view, null);
            viewHolder = new ViewHolder();
            viewHolder.shop_con = (LinearLayout) convertView.findViewById(R.id.shop_con);
            viewHolder.item_type = (TextView) convertView.findViewById(R.id.item_type);

            convertView.setTag(viewHolder);

        } else {
            viewHolder = (ViewHolder) convertView.getTag(R.drawable.icon+ position);
        }
        ...
        for (int i = 0; i < len; i++) {
            ...
            viewHolder.shopcart_item_ico = (ImageView) tempView.findViewById(R.id.shopcart_item_ico);
            ...
            viewHolder.shopcart_item_status = (TextView) tempView.findViewById(R.id.shopcart_item_status);
            ...
            addView(datas.get(index).stylenametwo,viewHolder.shopcart_item_cag, true, true);
...
//						viewHolder.shopcart_item_status.setVisibility(View.VISIBLE);
            ...
            viewHolder.shopcart_item_check.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                @Override
