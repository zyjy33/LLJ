...
//	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.tv_groupon_price2 = (TextView) convertView.findViewById(R.id.tv_groupon_price2);
			holder.tv_tuan2 = (TextView) convertView.findViewById(R.id.tv_tuan2);
			holder.tv_anniu2 = (TextView) convertView.findViewById(R.id.tv_anniu2);
			
			holder.tv_price3 = (TextView) convertView.findViewById(R.id.tv_price3);
			holder.tv_groupon_price3 = (TextView) convertView.findViewById(R.id.tv_groupon_price3);
			holder.tv_anniu3 = (TextView) convertView.findViewById(R.id.tv_anniu3);

			holder.ll_tupian = (ImageView) convertView.findViewById(R.id.ll_tupian);
			
			holder.ll_jutuan = (LinearLayout) convertView.findViewById(R.id.ll_jutuan);
			holder.ll_yushoutuan = (LinearLayout) convertView.findViewById(R.id.ll_yushoutuan);
			holder.ll_yiyuanjutou = (LinearLayout) convertView.findViewById(R.id.ll_yiyuanjutou);
