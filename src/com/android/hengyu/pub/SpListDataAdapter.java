...
public class SpListDataAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if (convertView == null) {
			convertView = LinearLayout.inflate(context,R.layout.goods_list_ll, null);
		}
...
//		loader.displayImage(RealmName.REALM_NAME_HTTP + lists.get(position).getImg_url(), img_ware);
