...
//		TextView tv = (TextView) convertView.findViewById(R.id.tv_user_address);
		...
		tv_user_address.setText("地址: "+list.get(position).province+"、"+list.get(position).city+"、"+user_area+"、"+user_address);
