...
//				img_detail.setData(images, imageLoader);
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		if(getIntent().hasExtra("id")){
			...
			AsyncHttp.post( "http://www.wxpalm.com.cn/mi/LY_Scenery.ashx?act=GetSceneryDetail", params, new AsyncHttpResponseHandler(){
				@Override
				public void onSuccess(int arg0, String arg1) {
					...
					try {
						...
						JSONArray jsonArray = jsonObject.getJSONArray("SceneryImgList");
						int len = jsonArray.length();
						  images = new ArrayList<String>();
						for(int i=0;i<len;i++){
							JSONObject object = jsonArray.getJSONObject(i);
							images.add(object.getString("sceneryImageUrl"));
						}
