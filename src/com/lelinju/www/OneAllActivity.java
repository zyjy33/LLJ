...
public class OneAllActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(bundle.containsKey("item_id")){
			...
			params.put("luckDrawBatchOrderNumber", getIntent().getExtras().getString("LuckDrawBatchOrderNumber"));
					...
					try {
						...
						if(TextUtils.equals(status, "1")){
							...
							for(int i=0;i<len;i++){
								...
								bean.setTime(object.getString("LuckDrawTime"));
								bean.setName(object.getString("username"));
								bean.setCode(object.getString("HengYuCode"));
								bean.setIp(object.getString("LuckIpAddress"));
								bean.setId(object.getString("YiYuanID"));
								bean.setCount(object.getString("LuckBuyCount"));
								lists.add(bean);
							}
