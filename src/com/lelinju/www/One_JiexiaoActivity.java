...
public class One_JiexiaoActivity extends BaseActivity{
	...
	private TextView tv_ware_market_money,market_information_title,item7,item8,item9;
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		img_layout.setLayoutParams(new LinearLayout.LayoutParams(widthPixels, widthPixels));
		itme6.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(One_JiexiaoActivity.this,OneResultActivity.class);
				...
				try {
					...
					if(status.equals("1")){
						...
						for(int i=0;i<len;i++){
							...
							if(oj.getString("LuckDrawBatchOrderNumber").equals(getIntent().getStringExtra("idex"))){
								AllJuGouCount = oj.getString("AllJuGouCount");
								AnnouncedTime = oj.getString("AnnouncedTime");
								ActualLuckNumber = oj.getString("ActualLuckNumber");
								HengYuCode = oj.getString("HengYuCode");
								username = oj.getString("username");
								LuckDrawBeginTime = oj.getString("LuckDrawBeginTime");
							}
						}
