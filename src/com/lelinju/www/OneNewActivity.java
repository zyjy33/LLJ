			...
			case 1:
				...
				one_new.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
							int arg2, long arg3) {
						Intent intent = new Intent(OneNewActivity.this,One_JiexiaoActivity.class);
						intent.putExtra("id",  lists.get(arg2).getId());
						intent.putExtra("LuckDrawBatchOrderNumber", lists.get(arg2).getLuckDrawBatchOrderNumber());
						intent.putExtra("idex", lists.get(arg2).getLuckDrawBatchOrderNumber());
