...
public class ComboDetalActivity extends BaseActivity {
	...
	private Handler handler = new Handler() {
		public void dispatchMessage(android.os.Message msg) {
			...
			case 0:
				...
				otherAdapter = new ComboOtherAdapter(getApplicationContext(), detailDomain.getItems(),
						imageLoader, handler);
	...
	private void loadData(String id) {
		...
		AsyncHttp.post(RealmName.REALM_NAME+"/mi/DianPing_Handler.ashx?act=GetOneDealDetail_ForMobile", params,
