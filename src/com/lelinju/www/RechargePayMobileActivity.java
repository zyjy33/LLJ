...
import com.lelinju.www.MyLetterListView.OnTouchingLetterChangedListener;
	...
	private void examble() {
		...
		btn_pay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				strUrl = RealmName.REALM_NAME + "/mi/99recharge.ashx?"
						+ "yth=" + yth + "&pwd=" + mipwd + "&paypwd="
						+ mipaypwd + "&mobile=" + infromation + "&fee="
						+ spmoney + "&orderid=" + orderid;
				...
				AsyncHttp.post_1(RealmName.REALM_NAME + "/mi/99recharge.ashx",param, new AsyncHttpResponseHandler(){
						@Override
