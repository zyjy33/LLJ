...
public class UserLoginWayActivity extends BaseActivity implements OnClickListener {
...
//				startActivity(intent);
	...
	private void onClickLogin() {
		...
		oauth_name = "qq";
		System.out.println("mQQAuth================"+mQQAuth);
...
//			
		...
		public void onError(UiError e) {
			Util.toastMessage(UserLoginWayActivity.this, "onError: " + e.errorDetail);
			Util.dismissDialog();
		}
