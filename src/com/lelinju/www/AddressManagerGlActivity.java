	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_add_address.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				int index = 1;
				Intent intent = new Intent(AddressManagerGlActivity.this,AddUserAddressActivity.class);
				...
				list_address.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
						...
						if (getIntent().hasExtra("order_confrim")) {
							...
							Intent intent = new Intent(AddressManagerGlActivity.this,EditUserAddressActivity.class);
							...
							// WashcarBean bean= lists.get(position);
							// Bundle bundle = new Bundle();
							// bundle.putSerializable("bean", bean);
							// intent.putExtras(bundle);
							// startActivity(intent);
