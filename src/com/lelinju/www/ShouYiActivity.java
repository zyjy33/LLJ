...
public class ShouYiActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		item1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				item1.setBackgroundColor(getResources().getColor(R.color.content_text));
				...
				try {
					...
					for(int i=0;i<len;i++){
						JSONObject object = jsonArray.getJSONObject(i);
						  ...
						  values.put("url", object.getString("avatarimageURL"));
						  values.put("count", object.getString("sumCount"));
	...
	private Handler handler = new Handler(){
		public void dispatchMessage(Message msg) {
			...
			case 0:
				...
				ShouYiAdapter adapter = new ShouYiAdapter(getApplicationContext(), lists, imageLoader,type);
