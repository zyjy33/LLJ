...
import com.lglottery.www.widget.LineBreakLayout;
...
public class WideMarketAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		...
		holder.item_img.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, length*120));
...
//		}
		...
		holder.item_img.setLayoutParams(new LinearLayout.LayoutParams(198 * 3,
				75 * ((len / 3) + 1)));*/
