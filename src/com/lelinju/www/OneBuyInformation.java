...
public class OneBuyInformation extends BaseActivity{
	...
	private LinearLayout market_information_describe,market_information_describe0,add_shop;
...
//				market_information_images.setData(getData(), imageLoader);
				...
				item2.setProgress((int)(Double.parseDouble(HasJoinedNum)/Double.parseDouble(NeedGameUserNum)*1000));
				item3.setText(HasJoinedNum);
				item4.setText(NeedGameUserNum);
				item5.setText(""+(Integer.parseInt(NeedGameUserNum)-Integer.parseInt(HasJoinedNum)));
				...
				for(int i=old_Number;i>0;i--){
					...
					textView.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View arg0) {
							...
							Intent intent = new Intent(OneBuyInformation.this,One_JiexiaoActivity.class);
							...
							System.out.println("期数："+idex+"---"+getIntent().getStringExtra("id"));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(	getIntent().hasExtra("id")){
			...
			market_information_describe.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(OneBuyInformation.this,WareInformationDetailsActivity.class);
					Bundle bundle = new Bundle();
					bundle.putInt("wareid", Integer.parseInt(getIntent().getStringExtra("id")));
					intent.putExtras(bundle);
					startActivity(intent);
				}
			});
			market_information_describe0.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(OneBuyInformation.this,OneAllActivity.class);
					Bundle bundle = new Bundle();
					bundle.putString("item_id", ""+productItemId);
					bundle.putString("LuckDrawBatchOrderNumber", LuckDrawBatchOrderNumber);
					intent.putExtras(bundle);
					startActivity(intent);
				}
			});
	...
	private void addNow() {
		...
		if (username.size() != 0) {
			...
			Intent intent = new Intent(OneBuyInformation.this,OrderConfrimActivity.class);
			intent.putExtra("isNow", true);
			intent.putExtra("Id", String.valueOf(iSLING == 0 ? CID : productItemId));
	...
	private RadioData[] parse(String st) {
		...
		try {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				LuckDrawBatchOrderNumber = object.getString("LuckDrawBatchOrderNumber");
//				"NeedGameUserNum": "90",
//				"HasJoinedNum": "0",
