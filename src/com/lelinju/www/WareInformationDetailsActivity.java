	...
	Handler handler = new Handler() {
		public void dispatchMessage(Message msg) {
			...
			case 0:
				...
				tv_detail.getSettings().setLayoutAlgorithm(LayoutAlgorithm.SINGLE_COLUMN);
...
//				tv_detail.loadData(details, "text/html", "UTF-8");
				...
				tv_detail.loadDataWithBaseURL("",newHtmlContent, "text/html", "UTF-8", null);
				break;
			default:
				break;
			}
	...
	private void parse(String st) {
		try {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				//ware_details = URLDecoder.decode(object.getString("proComputerInfo2"), "UTF-8");
